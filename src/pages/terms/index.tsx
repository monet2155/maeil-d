  ...
  return (
    <div className="flex flex-row">
      <div className="flex flex-col">
        ...
        <p>
          이 이용약관(이하 {"'약관'"}이라 합니다.)은 로망난녀석들(이하{" "}
          {"'회사'"}라 합니다.)이 제공하는 매일디 및 매일디 관련 제반
          서비스(이하 {"'서비스'"}라 합니다.)를 이용고객 (이하 {"'회원'"}이라
          합니다.)이 이용함에 있어서 회사와 회원과의 권리, 의무 및 책임사항,
        ...
        <ol>
          <li>
            이 약관은 그 내용을 회사의 웹사이트에 게시하거나 기타의 방법으로
          ...
          <li>
            회원은 정기적으로 웹사이트에 방문하여 약관의 변경사항을 확인하여야
            합니다. 변경된 약관에 대한 정보를 알지 못해 발생하는 회원의 피해는
            회사에서 책임지지 않습니다. 단 회원에게 불리한 약관의 개정의
            경우에는 공지 외에 일정기간 전자우편, 쪽지, 로그인시 동의양식 등의
            전자적 수단을 통해 따로 명확히 통지하도록 합니다.
          </li>
          <li>
            회원은 변경된 약관에 동의하지 않을 경우 회원탈퇴를 요청할 수
        ...
        <p>
          ...
          운영원칙(이하 {"'서비스 별 안내'"}라 합니다.)를 정할 수 있으며, 회원은
          각 서비스 별 안내에 대해 회원가입과 동시에 동의한 것으로 간주합니다.
          본 약관과 서비스 별 안내의 내용이 상충되는 경우에는 서비스 별 안내의
          내용을 우선하여 적용합니다.
        </p>
        ...
        <ol>
          <li>
            ...
            수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 아이디, 이메일
            등은 수정이 불가능합니다.
          </li>
          <li>
        ...
        <ol>
          <li>
            회원의 아이디와 비밀번호 그리고 이메일에 관한 관리책임은 회원에게
        ...
        <ol>
          ...
          <li>
            회원이 현금 및 사이버머니 등 거래에 필요한 내용을 확인하여 이에
        ...
        <ol>
          <li>
            회사의 본 약관상 환불규정 등은 약관의 규제에 관한 법률, 온라인
            디지털콘텐츠산업 발전법, 전자상거래 등에서의 소비자보호에 관한 법률
            등을 준수합니다.
          </li>
          <li>
            전 항의 관계법령에 따른 소비자의 청약철회가 불가능한 경우는 다음과
            같습니다.
            <ul>
              <li>
        ...
        <ol>
          <li>
            회사는 회원의 편의를 위하여 전 조 제1항의 관계법령에도 불구하고 본
            약관을 통하여 회원에게 좀 더 유리한 별도의 환불규정을 적용합니다.
          </li>
          <li>
            회원은 환불 또는 변경을 유ㆍ무선의 방법을 통하여 회사에 그 의사를
            표시하여야 하며, 회사는 환불요청을 접수하고 회원의 요청과 환불규정
            확인 후, 최대한 신속하게 환불하여 드립니다.
          </li>
          <li>
            회사의 환불 예외사항은 다음과 같습니다.
            <ul>
              <li>
                회원이 관계법령 및 본 약관의 규정을 위반하여 회사로부터 강제탈퇴
                처리가 되는 경우에는 본 조의 환불규정이 적용되지 않습니다.
              </li>
              <li>
                타인으로부터 양도받은(선물받은) 사이버머니에 대해서는 환불이
                불가능합니다.
              </li>
              <li>
                회사가 회원에게 무료로 지급한 사이버머니나 할인쿠폰 등으로 인해
                회원이 획득하게 된 금액에 대해서는 환불되지 않습니다.
              </li>
            </ul>
          </li>
          <li>
            환불 과정에서 금융수수료가 발생하는 경우, 관련 법률에 따라
            결제금액의 10%를 공제하고 환불할 수 있습니다.
          </li>
          <li>
            4항에도 불구하고 회사는 신뢰도 제고나 이벤트를 위해 일시적으로 환불
            조건을 완화할 수 있습니다.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            회사는 긴급한 시스템 점검, 증설 및 교체, 설비의 장애, 서비스 이용의
            폭주, 정전, 국가비상사태, 천재지변 등 부득이한 사유가 발생한 경우
            사전 예고 없이 일시적으로 서비스를 중지할 수 있습니다.
          </li>
        </ol>
        ...
        <ol>
          <li>
            게시물은 회원이 서비스를 이용하면서 게시한 글, 사진, 각종 파일과
            링크, 디지털 콘텐츠 등을 말합니다.
          </li>
          <li>
          ...
          <li>
            ...
            침해를 이유로 게시중단 요청을 받은 경우 이를 임시로 게시를 중단 할
            수 있으며, 이의를 제기한 자와 게시물 등록자 간에 소송, 합의 등을
            통해 당해 게시물에 관한 법적 문제가 종결된 후 이를 근거로 회사에
            신청이 있는 경우에만 상기 임시로 게시가 중단된 게시물은 다시 게시될
            수 있습니다.
          </li>
          <li>
            회원이 이용계약해지를 한 경우 회원이 등록한 게시물은 자동 삭제되지
            않으며 이용계약 해지 전에 직접 삭제를 하거나 요청을 할 경우 회사는
            요청한 게시물을 삭제합니다.
          </li>
        </ol>
        ...
        <ol>
          <li>
            회사가 작성한 게시물 또는 저작물에 대한 저작권 기타 지적재산권은
            회사에 귀속합니다.
          </li>
          <li>
            회원이 서비스 내에 게시한 게시물의 저작권은 원칙적으로 게시한
            회원에게 귀속됩니다. 단, 회사는 서비스의 운영, 전시, 전송, 배포,
            홍보 등의 목적으로 회원의 별도의 허락 없이 무상으로 회원이 등록한
            게시물을 사용할 수 있습니다.
          </li>
          <li>
            회원이 올린 디지털 콘텐츠가 회원의 동의 없이 타인에 의해 무단, 불법
            복제되어 회원뿐 아니라 회사의 이익에 상충할 경우 회사는 회원을
            대리해 저작권을 행사할 수 있습니다. 단, 이 경우 회사는 회원에게
            개별적 동의를 구합니다.
          </li>
          <li>
            회사는 본 조 제 2항 이외의 목적으로 회원의 게시물을 사용하고자 하는
        ...
        <ol>
          <li>
            회원은 언제든지 1:1문의 등을 통하여 이용계약 해지 신청을 할 수
          ...
          <li>
            회원이 계약을 해지하는 경우, 회원이 작성한 게시물의 원본은
            삭제됩니다.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            ...
            저작권법 및 컴퓨터프로그램보호법을 위반한 불법프로그램의 제공 및
            운영방해, 정보통신망법을 위반한 불법통신 및 해킹, 악성프로그램의
            배포, 접속권한 초과행위 등과 같이 관련법을 위반한 경우에는 즉시
            영구이용정지를 할 수 있습니다. 본 항에 따른 영구이용정지 시 서비스
            이용을 통해 획득한 수익 등 기타 혜택 등도 모두 소멸되며, 회사는 이에
            대해 별도로 보상하지 않습니다.
          </li>
          <li>
        ...
        <ol>
          <li>
            ...
            <ul>
              <li>
                동일한 계정으로 2대 이상의 PC에서 동시접속이 발생하는 경우
              </li>
              <li>
              ...
              <li>
                자신의 계정의 서비스를 타인에게 판매, 대여, 양도하는 행위 및
                이를 광고하는 행위
              </li>
              <li>
          ...
          <li>
            회사는 전항에 따른 부정 이용자가 발견 되었을 경우, 다음 각호에 따른
            조치를 취할 수 있습니다.
            <ul>
          ...
          <li>
            회원은 전항 제2호의 조치를 이유로, 서비스 이용기간의 연장을 요구할
            수 없습니다.
          </li>
          <li>
            회원은 회사로부터의 본 조 제2항의 조치에 이의가 있는 경우, 회사의
        ...
        <ol>
          ...
          <li>
            회사는 CP가 제공하거나 회원이 작성하는 등의 방법으로 서비스에 게재된
            정보, 자료, 사실의 신뢰도, 정확성 등에 대해서는 보증을 하지 않으며
